 ...
 * Hint: [start, middle, 1, end, success]
 ...
 * Hint: [start, end, resolve, setTimeout]
 */
// console.log("start");
//
// setTimeout(() => {
 ...
 * Hint: [1, 2, 4, 'timerStart','timerEnd', 'success']
 ...
 * Hint: [start, 'end', 'promise1', 'timer1', 'promise2', 'timer2']
 */
// console.log('start');
//
// const promise1 = Promise.resolve().then(() => {

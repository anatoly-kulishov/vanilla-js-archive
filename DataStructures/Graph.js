/**
 * A graph is a data structure consisting of a set of nodes or vertices and a set of edges that represent connections between those nodes.
 * Graphs can be directed or undirected, while their edges can be assigned numeric weights.
 *
...
[...g.edges.values()].map(({a, b}) => `${a} => ${b}`); // ['a => c', 'b => c', 'c => b', 'd => a']

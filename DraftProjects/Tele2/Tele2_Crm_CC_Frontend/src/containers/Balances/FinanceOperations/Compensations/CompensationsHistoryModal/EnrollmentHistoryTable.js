...
export const EnrollmentHistoryTable = ({ paymentsHistory, handlePaymentDetailsOpening, isEnrollments, isLoading }) => {
  ...
  return (
    ...
    >
      ...
      <Table.Column
        ...
        width={isEnrollments ? '25%' : '20%'}
        sorter={(cur, next) => stringSorter(cur.DocumentType, next.DocumentType)}
      />
      <Table.Column
        dataIndex='BalanceName'
        title='Баланс'
        width={isEnrollments ? '35%' : '20%'}
...
EnrollmentHistoryTable.propTypes = {

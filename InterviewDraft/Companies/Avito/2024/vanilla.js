...
//         // Локальные изменения
//         price.rub = 4000;   // Изменение объекта по ссылке
...
//     console.log(price);      // {rub: 4000} - объект изменён внутри функции
 ...
 */
/**
 * Напишите функцию retryFetch поверх fetch API,
 * которая отправляет запрос в случае неудачи и раз * Функция принимает те же параметры,
 * что и fetch + количество попыток и возвращает Promise.
 *

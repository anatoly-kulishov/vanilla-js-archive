...
console.log('Result:', letterCombinations('23')); // ["ad","ae","af","bd","be","bf","cd","ce","cf"]
console.log('Result:', letterCombinations('234')); // ["adg","adh","adi","aeg","aeh","aei","afg","afh","afi","bdg","bdh","bdi","beg","beh","bei","bfg","bfh","bfi","cdg","cdh","cdi","ceg","ceh","cei","cfg","cfh","cfi"]
console.log('Result:', letterCombinations('')); // []
console.log('Result:', letterCombinations('2')); //  ["a","b","c"]
